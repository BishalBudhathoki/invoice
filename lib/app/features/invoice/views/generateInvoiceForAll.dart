...
class GenerateInvoiceForAll extends StatefulWidget {
  final String email;
  final String genKey;
  const GenerateInvoiceForAll(this.email, this.genKey, {super.key});
...
class _GenerateInvoiceForAllUserState extends State<GenerateInvoiceForAll> {
                ...
                SizedBox(
                  ...
                  child: ButtonWidget(
                    ...
                    onPressed: () {
                      ...
                      downloadService.downloadFiles(pdfPaths);
                    },
                    hasBorder: false,
                  ),
                ),
