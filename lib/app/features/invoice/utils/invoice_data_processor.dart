...
class InvoiceDataProcessor {
  ...
  Future<Map<String, dynamic>> processInvoiceData(
    ...
    final List<Map<String, dynamic>> processedLineItems =
        lineItems ?? lineItemController.lineItems;

    Map<String, String> itemMap = _createItemMap(processedLineItems);
    ...
    for (var userDocItem in userDocs) {
      ...
      for (var doc in docs) {
        if (doc is Map<String, dynamic>) {
          Map<String, dynamic> clientData = _processClientData(
              doc,
  ...
  Map<String, dynamic> _processClientData(Map<String, dynamic> doc,
      List<dynamic> clientDetails, Map<String, String> itemMap, bool applyTax) {
